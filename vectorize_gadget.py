...
class GadgetVectorizer:
    ...
    """
    Takes a line of JavaScript code (string) as input
    Tokenizes JavaScript code (breaks down into identifier, variables, keywords, operators)
    ...
    def tokenize_gadget(gadget):
        tokenized = []
        function_regex = re.compile(r'\bfunction\b')
